...
const Article = () => {
    ...
    return (
        ...
        <PageLayout blogwithsidebar ads={ads}>
            <Text p>
                This current article is made using <b>blogwithsidebar</b> layout. This layout will be used to write your
            ...
            <CodeBlock
                ...
                className='my-5'
            />
            The above code snippet gives you a demo on how to use blogwithsidebar layout. The current article that you
            see is the basic output/example of blogwithsidebar layout which will consist of a navbar on the top, a side
            bar and the main content area. The side bar will content author details and more articles by the author.
            {/* </Text> */}
            ...
            <List type={ListType.disc}>
                <li>
                    This layout is of contained width i.e has a max width same as the navbar, this is to keep the
                    article / blog posts style consistent.
                </li>
                <li>In the sidebar on the right, we have author details and more articles from the author.</li>
                <li>
                    We can also place ads on the right sidebar.
                    <CodeBlock code={rightSideAdCode} className='my-5' />
            ...
            <Text p>
                Check <u>blog-with-sidebar-layout.tsx</u> in <u>pages/tutorial</u> file to see all the mentioned
                components in use.
            </Text>
            <Text>
                Check <u>blog-with-sidebar-layout.tsx</u> in <u>pages/tutorial</u> file to see all the mentioned
            ...
            <List type={ListType.number}>
                ...
                <li>
                    <b>{'Image'}</b> tag for displaying images. <br /> To use image we have to import <b>Image</b> from
                    components and <b>ImageSize</b> enum from enums. The Image size will help us to set the size of the
                    image. <br /> Available sizes:{' '}
                    <b>ImageSize.DEFAULT, ImageSize.FULL, ImageSize.MEDIUM, ImageSize.SMALL, ImageSize.XS</b>.
                    <CodeBlock code={HowToUseImageCode} className='my-5' />
                </li>
                <li>
                    <b>{'Text'}</b>. <br /> We use this to write content/text. To use image we have to import{' '}
                    <b>Text</b> from components. We have different Text types like <b>title, subtitle, p, quote</b> with
                    default styles and by default it is of type paragraph.
                    <CodeBlock code={HowToUseTextCode} className='my-5' />
                </li>
                <li>
                    <b>{'List'}</b> <br />
                    This is used to display lists. We have 3 different types:{' '}
                    <b>ListType.disc | ListType.number | ListType.none</b>, by default it is of type ListType.disc.
                    <CodeBlock code={HowToUseList} className='my-5' />
                </li>
                <li>
                    <b>{'Seperator'}</b>
                    <br />
                    This is used to add a section sepertator. We have 2 types:{' '}
                    <b>
                        {'<Seperator dots/>'} or {'<Seperator line/>'}
                    </b>
                    , by default it is of type line.
                    <CodeBlock code={HowToUseSeperator} className='my-5' />
                </li>
            </List>
            <Text p>
                <b>note:</b> all these components are used in <u>blog-with-sidebar-layout.tsx</u> and{' '}
                <u>blog-with-centerd-layout.tsx</u> in <u>pages/tutorial</u>. You can also check{' '}
                <b>
                    <LinkTo href='/pages/tutorial/all-components.tsx' passHref>
                        All Components Demo
                    </LinkTo>
                </b>
                , list of all components, its types and how to use them.
            </Text>
