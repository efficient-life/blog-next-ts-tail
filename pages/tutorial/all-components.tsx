...
import { PageLayout, Text, LinkTo, Slider, Seperator, Image, List, Accordian, VideoPlayer } from '../../src/components';
        ...
        <PageLayout>
            <section className='container md:pt-10 pt-20 px-0 md:px-[15px]'>
                <div className='md:px-0 px-3'>
                    ...
                    <hr className='my-5' />
                    <Text subtitle>List of all components, its types and how to use it.</Text>
                </div>
                ...
                <div className='flex md:flex-nowrap flex-wrap relative items-start mt-8'>
                    ...
                    <aside className='md:w-4/5 w-full md:px-[15px]'>
                        <section className={cardBBorder} id='pageLayouts'>
                            ...
                            ,{' '}
                            <u>
                                <LinkTo href='/pages/tutorial/blog-with-sidebar-layout.tsx'>Blog with sidebar</LinkTo>
                            </u>{' '}
                            and{' '}
                            <u>
                                <LinkTo href='/pages/tutorial/blog-with-centered-layout.tsx'>Blog centered</LinkTo>
                            </u>
                            . <br />
                            <b>How to use</b>
                        ...
                        <section className={cardBBorder} id='text'>
                            ...
                            Text is used to write Paragraphs, Title, Sub title or Quotes in the article. <br />
                            <br />
                            <b>Demo</b>
                            ...
                            <Text p>
                                <b>Note:</b> By default we have some standard styles applied to the Text component, so
                                if you need to override like text size, weight you can do as follows: <br />{' '}
                                <b>
                                    {'<Text p className="!text-[20px] !font-bold">Overide text size and weight</Text>'}
                                </b>{' '}
                                <br /> by adding <b>!</b> in front of the classes we can change the default styles like
                                here font size will be changed to 22px and font weight will change to bold for paragraph{' '}
                            </Text>{' '}
                            <br />
                            <b>How to use</b>
                            <CodeBlock code={HowToUseTextCode} className='my-5' />
                            you can find more tailwind font classes on the official docs{' '}
                            <LinkTo href='https://tailwindcss.com/docs/font-size' className='underline' external>
                                here
                            </LinkTo>
                            .
                        </section>
                        ...
                        <section className={cardBBorder} id='image'>
                            ...
                            To add image in your project, first save the image file in <b>{`public --> images`}</b>{' '}
                            folder and then add the image path in image tag's src. For demo check{' '}
                            <b>/pages/all-components.tsx</b> file in code. <br />
                            <br />
                            <b>Demo</b>
                        ...
                        <section className={cardBBorder} id='seperator'>
                            ...
                            <b>{'<Seperator dots/>'}</b> or <b>{'<Seperator line />'}</b> these are used to add a
                            section divider as shown below. <br /> <br />
                            <b>Demo</b>
                            <Seperator dots />
                            <Seperator line />
                            <b>How to use</b>
